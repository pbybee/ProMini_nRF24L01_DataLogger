...
int accelDataX[DATAARRAYSIZE];
int accelDataY[DATAARRAYSIZE];
int accelDataZ[DATAARRAYSIZE];
int gyroDataX[DATAARRAYSIZE];
int gyroDataY[DATAARRAYSIZE];
int gyroDataZ[DATAARRAYSIZE];
